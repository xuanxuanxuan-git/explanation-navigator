...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: 'system-ui, Arial', padding: "5px 20px 5px 20px", height: "97vh", boxSizing: "border-box", maxWidth: 1300, minWidth: 900, minHeight: 700, margin: "0 auto"}}>

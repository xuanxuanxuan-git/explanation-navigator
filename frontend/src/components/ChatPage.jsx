  ...
  */
  ...
  const handleDesignCQuestion = (q, category) => {
    ...
    if (category === "tellsYou") {
      ...
      promptText = `Explain briefly why the currently shown explanation "${visibleTexts.ui}" cannot answer my question: "${q}". Use the appropriate tool to generate the explanation that can answer it.`
    }

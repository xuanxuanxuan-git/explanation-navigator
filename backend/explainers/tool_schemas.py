...
explainer_tools = [
    {
        ...
        "description": "Shows what factors pushed ONE specific applicant's predicted score up or down and by how much. "
            ...
            "Generation: This chart is generated by comparing your specific details to the average applicant to see how much each factor pushed your score up or down. Because it looks at your current profile, it explains your current score but does not predict what happens if you change your behaviour.", 
    ...
    },
    {
        ...
        "Generation: This chart is generated by keeping all your details exactly the same while testing hypothetical changes to just one factor. Because it only tests one factor at a time not how much a feature matters relative to other features, it cannot rank which factors were most important for your current score.",

...
explainer_tools = [
    {
        ...
        "description": "Generates 'What affected your score' chart for ONE specific applicant. Shows what factors pushed ONE specific applicant's predicted score up or down and by how much. "
            ...
            "Generation: This chart is generated by comparing your current details to an average applicant and see how much each factor moved the system's prediction from its baseline to your score. Because it looks at your current profile, it explains your current score but does not predict what happens if you change your factors.", 
    ...
    },
    {
        ...
        "description": """
            ...
            Generation: This chart is generated by averaging the data of many applicants to see which factors matter most overall. Because it is a system-wide average, it tells us the general rules but does not explain your specific, individual decision.'", 
        """,
    ...
    },
    {
        ...
        "Note: This explanation only applies for a specific applicant. Feature must match a valid factor name exactly. "
        "Generation: This chart is generated by keeping all your details exactly the same while testing how the predicted score would change when only changing one factor. Because it only tests one feature at a time not how much a feature matters relative to other features, it cannot rank which features were most important for your current score.",
    ...
    },
    {
        ...
        "description": (
            ...
            "Generation: This chart is generated by searching for the smallest tweaks to your current profile that would bump your score to the target, without considering feature importance."
        ),
    ...
    },
    {
        ...
        "description": (
            ...
            "Generation: This chart is generated by taking all applicants in the dataset, pretending they all have the same value for this factor, and averaging their scores to see the overall trend. Because the user has a unique combination of other factors, their personal trend (which requires a ICE plot) can differ from this average."
        ),
